...
public class MandoElytraItem extends ElytraItem implements IArmorVanishable {
   public MandoElytraItem(Item.Properties p_i48507_1_) {
      super(p_i48507_1_);
   ...
   public boolean isValidRepairItem(ItemStack p_82789_1_, ItemStack p_82789_2_) {
      return p_82789_2_.getItem() == Items.FIRE_CHARGE;
   }
   ...
   public boolean canElytraFly(ItemStack stack, net.minecraft.entity.LivingEntity entity) {
      return MandoElytraItem.isFlyEnabled(stack);
   }
