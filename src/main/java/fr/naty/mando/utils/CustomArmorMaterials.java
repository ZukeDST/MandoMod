...
public enum CustomArmorMaterials implements IArmorMaterial {
    ...
    BESKAR_ARMOR(mando.MODID + ":beskar", 18, new int[]{2, 5, 7, 3}, 15, SoundEvents.ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> {
        return Ingredient.of(MandoItems.BESKAR_INGOT.get());
    }),
	
	
    BESKAR_ARMOR_JETPACK(mando.MODID + ":beskar_jetpack", 18, new int[]{2, 5, 7, 3}, 15, SoundEvents.ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> {
        return Ingredient.of(MandoItems.BESKAR_INGOT.get());
    });
