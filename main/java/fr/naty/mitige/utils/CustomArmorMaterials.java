...
public enum CustomArmorMaterials implements IArmorMaterial {
    ...
    BESKAR_ARMOR(mitige.MODID + ":beskar", 18, new int[]{2, 5, 7, 3}, 15, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> {
        return Ingredient.fromItems(MitigeItems.BESKAR_INGOT.get());
    }),
	
	
    BESKAR_ARMOR_JETPACK(mitige.MODID + ":beskar_jetpack", 18, new int[]{2, 5, 7, 3}, 15, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0f, 0.0f, () -> {
        return Ingredient.fromItems(MitigeItems.BESKAR_INGOT.get());
    });
